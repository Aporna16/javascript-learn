...
console.log(typeof sum); //variable er type check korar system...
console.log(sum);
*/
...
var num3 = 20;
var num4 = "20.66666";
const convertNum4 = parseFloat(num4);
const add = num3 + convertNum4;
console.log(typeof add); //variable er type check korar system...
console.log(add);
